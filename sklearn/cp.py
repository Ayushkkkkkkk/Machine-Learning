...
def tagpdf(pathac="", num=1, urll=''):
    ...
    for i in range(0, num):
        ...
        pdfkit.from_url(a, path + str(data['result']['problems'][i]['contestId']) + str(
            data['result']['problems'][i]['index']))


def gettags():
    tags = ["implementation", "binary search", "math", "data structures", "dfs and similar", "graphs", "combinatorics",
            "constructive algorithms", "dp", "greedy", "strings", "hashing", "two pointers",
            "bitmasks", "sortings", "string suffix structures", "geometry", "dsu", "divide and conquer", "trees",
            "games", "probabilities"]
    print("\n")
    print("	*********************** \n ")
    ...
    path = ""
    print(
        '	Enter the directory path where the problems are to be downloaded or leave blank, by default it is the working directory of script\n')
    path = input()
